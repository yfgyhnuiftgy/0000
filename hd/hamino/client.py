...
class Client(Wss, Session):
    ...
    def sid_login(self, sid: str, uid = None):
    ...
    def get_my_communities(self, start: int = 0, size: int = 50):
    ...
    def join_community(self, comId: str, InviteId: str = None):
        req = self.postRequest(f"/x{comId}/s/community/join")
        return Json(req)
